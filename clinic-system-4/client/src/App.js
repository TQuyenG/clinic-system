      ...
      <DepartmentColorProvider>
        <AuthProvider>
          <MainLayout>
            ...
            {/* ✅ MY FORUM PAGE - Câu hỏi của tôi / Đã lưu / Yêu thích */}
            <Route 
            ...
            <Route path="/danh-sach-ho-so" element={<ProtectedRoute requiredRole="patient"><MyMedicalRecordsPage /></ProtectedRoute>} />
