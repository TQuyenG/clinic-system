 ...
 * Admin/Staff Support có quyền 'consultations:view'
 */
router.get(
  '/:id',
  authMiddleware,
...
// ==================================================================
// ⚠️ PHÂN QUYỀN REALTIME CHO STAFF SUPPORT
// Staff Support có quyền giám sát, gửi tin nhắn, xử lý sự cố
// ==================================================================

/**
 * 📋 DANH SÁCH TƯ VẤN REALTIME - Yêu cầu quyền 'consultations:view'
...
/**
 * 📡 GIÁM SÁT PHIÊN ĐANG HOẠT ĐỘNG - Yêu cầu quyền 'consultations:view'
...
/**
 * 💬 XEM NỘI DUNG CHAT (Read-only) - Yêu cầu quyền 'consultations:view'
...
/**
 * 📢 GỬI TIN NHẮN HỆ THỐNG - Yêu cầu quyền 'consultations:reply'
 * POST /api/consultations/admin/realtime/:id/system-message
 * Staff Support có thể gửi thông báo hệ thống vào phòng chat
 */
router.post(
  '/admin/realtime/:id/system-message',
  authMiddleware,
  roleMiddleware('consultations:reply'),
  consultationAdminController.sendSystemMessage
);

/**
 * 🛑 KẾT THÚC PHIÊN THỦ CÔNG - Yêu cầu quyền 'consultations:close'
 * PUT /api/consultations/admin/realtime/:id/force-end
 * Dùng khi phiên bị lỗi, cần ngắt kết nối thủ công
 */
router.put(
...
/**
 * 🚨 DANH SÁCH SỰ CỐ (Incidents) - Yêu cầu quyền 'consultations:view'
...
/**
 * ✅ XỬ LÝ (ĐÓNG) SỰ CỐ - Yêu cầu quyền 'consultations:close'
