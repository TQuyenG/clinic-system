        ...
        <nav>
          ...
          {user.role === 'patient' && (
            <>
              ...
              <Link 
                to="/tu-van" 
                className={location.pathname.startsWith('/tu-van') ? 'active' : ''} 
                onClick={closeSidebar}
              >
                <FaComments />
              ...
              <Link 
                to="/tu-van/lich-su" 
                className={location.pathname === '/tu-van/lich-su' ? 'active' : ''} 
                onClick={closeSidebar}
              >
                <FaHistory />
                ...
                <div className="sidebar-menu-group">
                  ...
                  {isConsultationMenuOpen && (
                    <div className="submenu">
                      <Link
                        to="/admin/tu-van"
                        className={location.pathname === '/admin/tu-van' ? 'active' : ''}
                        onClick={closeSidebar}
                      >
                        <span>•</span> Tổng quan tư vấn
                      </Link>
                      <Link
