                ...
                <div className="appointment-body">
                  ...
                  <div className="appointment-actions">
                    <button
                      ...
                      // Use appointment.code because the detail route expects the appointment code, not numeric DB id
                      onClick={() => navigate(`/lich-hen/${appointment.code}`)}
                    >
                      <FaEye /> Chi tiết
                    </button>
                    ...
                    {appointment.status === 'confirmed' && !appointment.MedicalRecord && (
                      <button
                        ...
                        // Route /nhap-ket-qua/:code expects the appointment code as parameter
                        onClick={() => navigate(`/nhap-ket-qua/${appointment.code}`)}
                      >
