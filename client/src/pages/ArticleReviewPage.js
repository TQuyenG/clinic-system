...
const ArticleReviewPage = () => {
  ...
  const canApprove = isAdmin || hasPermission('articles', 'approve');
        ...
        <div className="review-article-layout">
          ...
          <div className="review-article-main-content">
            ...
            <div className="review-article-discussion-section">
              ...
              {/* COMMENT FORM - TÁC GIẢ, ADMIN HOẶC NGƯỜI CÓ QUYỀN APPROVE MỚI COMMENT ĐƯỢC */}
              {(canApprove || isAuthor) && (
              ...
              {!canApprove && !isAuthor && (
                <div className="review-article-comment-notice" style={{
                  padding: '15px',
                  ...
                  <FaInfoCircle />
                  <span>Bạn cần có quyền "Duyệt bài viết" hoặc là tác giả để trao đổi trong trang phê duyệt.</span>
                </div>
              )}
