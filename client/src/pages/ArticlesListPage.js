  ...
  return (
    <div className="article-list-page">
      ...
      <div className="article-list-page-header">
        ...
        <p className="article-list-subtitle">Khám phá kiến thức y tế và sức khỏe</p>
      </div>

      <div className="article-list-filters-section">
        <div className="article-list-filters-bar">
          <div className="article-list-search-box">
            <FaSearch />
            <input
              type="text"
              name="search"
          ...
          <button 
            className="article-list-btn-toggle-filters"
          ...
          {(filters.search || filters.category_id || filters.tag || (!type && filters.category_type)) && (
            <button className="article-list-btn-clear" onClick={clearFilters}>
              <FaTimes /> Xóa lọc
            </button>
          )}
        </div>
        ...
        {showFilters && (
          <div className="article-list-advanced-filters">
            <div className="article-list-filter-row">
              {!type && (
                <div className="article-list-filter-item">
          ...
          <div className="article-list-articles-grid">
            {articles.map(article => (
              ...
              >
                ...
                <p className="article-list-card-excerpt">
