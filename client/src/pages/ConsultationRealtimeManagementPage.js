...
const ConsultationRealtimeManagementPage = () => {
  ...
  const fetchDashboardStats = async () => {
    try {
      setLoading(true);
      const response = await consultationService.getAdminRealtimeStatisticsOverview();
  ...
  return (
    <div className="consultation-realtime-management-page">
      ...
      <div className="realtime-content-area">
        ...
        {activeTab === 'feedbacks' && (
          <ConsultationFeedbackManagement />
        )}
