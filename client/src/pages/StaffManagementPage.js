...
const PERMISSION_MODULES = {
  ...
  consultations: {
    ...
    icon: <FaLightbulb />,
    permissions: [
      { key: 'view', label: 'Xem', description: 'Xem yêu cầu tư vấn' },
      { key: 'reply', label: 'Trả lời', description: 'Trả lời tư vấn' },
      { key: 'assign', label: 'Phân công', description: 'Phân công nhân viên tư vấn' },
      { key: 'close', label: 'Đóng', description: 'Đóng yêu cầu tư vấn' }
    ]
  },
  payments: {
    name: 'Thanh toán',
...
const DEPARTMENT_MODULE_ACCESS = {
  ...
  clinical: ['work_shift', 'appointments', 'doctors', 'patients', 'medical_records'],
