      ...
      <AuthProvider>
        <MainLayout>
          <Routes>
            ...
            {/* QUAN TRỌNG: Route cụ thể đặt trước route động */}
            ...
            {/* [TỪ CODE 2] Sửa lỗi 404 cho bác sĩ */}
            <Route 
            ...
            {/* Lưu ý: Code 2 KHÔNG có ServiceForm, nên tôi không thêm vào đây theo yêu cầu của bạn */}
            
            {/* [TỪ CODE 2] Entity Management (Quản lý Thuốc/Bệnh lý) */}
            <Route path="/quan-ly-thuoc" element={<ProtectedRoute requiredRole="admin"><EntityManagementPage entityType="medicine" /></ProtectedRoute>} />
            <Route path="/quan-ly-benh-ly" element={<ProtectedRoute requiredRole="admin"><EntityManagementPage entityType="disease" /></ProtectedRoute>} />
            ...
            {/* [TỪ CODE 2] Forum & Report Management */}
            ...
            {/* [TỪ CODE 2] Consultation Package Management */}
            ...
            <Route path="/quan-ly-thanh-toan/chinh-sach" element={<ProtectedRoute requiredRole="admin"><RefundPolicyConfigPage /></ProtectedRoute>} />
            {/* --------------------------- */}
            <Route path="/quan-ly-thanh-toan/thong-ke" element={<ProtectedRoute requiredRole="admin"><StatisticsPage /></ProtectedRoute>} />
